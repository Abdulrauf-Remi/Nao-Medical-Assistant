...
class Dialog(object):
    ...
    def answer(self, question):
        if "hello" in question or "hi" in question:
            ...
            return "We are in the Goethe Institut library"
        elif "what is your name" in question:
            return "I am Enam, your medical assistance."
            ...
            return "Once upon a time, there is a robot. Emmm, go back to work and no story!" 
        elif "what can you do" in question:
            return "I am medical assistance, I can diagosis diesases, recommend treatment, and take medical documentation"
